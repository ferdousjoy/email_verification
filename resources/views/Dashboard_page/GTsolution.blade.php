  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"> GT Solution Upload</h5>
      ...
      <div class="modal-body">
        <div class="row input_row">
          <div class="">
            <form class="" action="/gtsolution/insert" method="post" enctype="multipart/form-data">
              @csrf
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="{{route('E2', $key->id)}}"> <i class="fa fa-edit"></i></a>
        <a href="{{route('D4', $key->id)}}"> <i class="fa fa-trash"></i></a>
      </td>
    </tr>
    @endforeach
