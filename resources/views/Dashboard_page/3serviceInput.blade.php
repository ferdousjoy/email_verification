...
<style media="screen">
 ...
 <h1> Welcome To Three Specific Service Page</h1><hr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"> Three Specific Service Detail</h5>
      ...
      <div class="modal-body">
        <div class="row input_row">
          <div class="">
            <form class="" action="{{url('/Specific/Update/three')}}" method="post" enctype="multipart/form-data">
              @csrf
