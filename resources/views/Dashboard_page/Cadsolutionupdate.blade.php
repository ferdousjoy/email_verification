...
<a type="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModalLong">
   <h6 class="head_title">Update  CAD Solution</h6>
</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Cad Solution Update</h5>
      ...
      <div class="modal-body">
        <div class="row input_row">
          <div class="">
            <form class="" action="{{url('/U3')}}" method="post" enctype="multipart/form-data">
              @csrf
