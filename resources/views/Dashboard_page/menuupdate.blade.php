...
<a type="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModalLong">
   <h6 class="head_title">Update  Menu</h6>
</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Menu Update</h5>
      ...
      <div class="modal-body">
        <div class="row input_row">
          <div class="">
            <form class="" action="{{url('/Um')}}" method="post" >
              @csrf
              ...
              <input type="text" id="form1" class="form-control"  value="{{$attach->link}}"  placeholder="link" name="link"><br>
