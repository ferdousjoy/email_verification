  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Event Upload</h5>
      ...
      <div class="modal-body">
        <div class="row input_row">
          <div class="">
            <form class="" action="{{url('/event/insert')}}" method="post" enctype="multipart/form-data">
              @csrf
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="{{route('E5', $key->id)}}"> <i class="fa fa-edit"></i></a>
        <a href="{{route('D10', $key->id)}}"> <i class="fa fa-trash"></i></a>
      </td>
    </tr>
    @endforeach
