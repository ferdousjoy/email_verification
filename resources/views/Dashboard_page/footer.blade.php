    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row input_row">
          <div class="">
            <form class="" action="{{url('/footer/insert')}}" method="post" enctype="multipart/form-data">
              @csrf
              <h2 class="head_title">Upload <i class="fa fa-cloud"></i></h2>
               
              <input type="text" id="form1" class="form-control" placeholder="Detail" name="detail"><br>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="{{route('D999', $key->id)}}"> <i class="fa fa-trash"></i></a>
      </td>
    </tr>
    @endforeach
